...
ALTER TABLE ci_erp_users ADD COLUMN totp_secret VARCHAR(32);
ALTER TABLE ci_erp_users ADD COLUMN totp_enabled SMALLINT DEFAULT 0;
...
ALTER TABLE ci_erp_company_settings ADD COLUMN office_latitude NUMERIC(10,7);
ALTER TABLE ci_erp_company_settings ADD COLUMN office_longitude NUMERIC(10,7);
ALTER TABLE ci_erp_company_settings ADD COLUMN geofence_radius_m INTEGER DEFAULT 300;
...
-- 3.2: Stripe subscription billing
...
ALTER TABLE ci_company_membership ADD COLUMN show_modal SMALLINT DEFAULT 0;
...
ALTER TABLE ci_erp_users ADD COLUMN is_demo SMALLINT DEFAULT 0;
