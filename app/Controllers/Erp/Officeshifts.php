...
class Officeshifts extends BaseController {
	...
	{		
		...
		$data['breadcrumbs'] = lang('Dashboard.left_office_shifts');
	...
	public function add_office_shift() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$shift_name = strip_tags(trim($this->request->getPost('shift_name')));
				$monday_in_time = strip_tags(trim($this->request->getPost('monday_in_time')));
				$monday_out_time = strip_tags(trim($this->request->getPost('monday_out_time')));
				$tuesday_in_time = strip_tags(trim($this->request->getPost('tuesday_in_time')));
				$tuesday_out_time = strip_tags(trim($this->request->getPost('tuesday_out_time')));
				$wednesday_in_time = strip_tags(trim($this->request->getPost('wednesday_in_time')));
				$wednesday_out_time = strip_tags(trim($this->request->getPost('wednesday_out_time')));
				$thursday_in_time = strip_tags(trim($this->request->getPost('thursday_in_time')));
				$thursday_out_time = strip_tags(trim($this->request->getPost('thursday_out_time')));
				$friday_in_time = strip_tags(trim($this->request->getPost('friday_in_time')));
				$friday_out_time = strip_tags(trim($this->request->getPost('friday_out_time')));
				$saturday_in_time = strip_tags(trim($this->request->getPost('saturday_in_time')));
				$saturday_out_time = strip_tags(trim($this->request->getPost('saturday_out_time')));
				$sunday_in_time = strip_tags(trim($this->request->getPost('sunday_in_time')));
				$sunday_out_time = strip_tags(trim($this->request->getPost('sunday_out_time')));
