	...
	public function add_official_document() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$license_name = strip_tags(trim($this->request->getPost('license_name')));
				$document_type = strip_tags(trim($this->request->getPost('document_type')));
				$expiry_date = strip_tags(trim($this->request->getPost('expiry_date')));
				$license_number = strip_tags(trim($this->request->getPost('license_number')));
