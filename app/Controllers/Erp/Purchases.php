	...
	public function create_new_purchase() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$purchase_number = strip_tags(trim($this->request->getPost('purchase_number')));
				$supplier = strip_tags(trim($this->request->getPost('supplier')));
				...
				$purchase_note = strip_tags(trim($this->request->getPost('purchase_note')));
