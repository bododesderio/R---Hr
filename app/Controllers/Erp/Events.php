	...
	public function add_event() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$event_title = strip_tags(trim($this->request->getPost('event_title')));
				$event_date = strip_tags(trim($this->request->getPost('event_date')));
				$event_time = strip_tags(trim($this->request->getPost('event_time')));
				$event_color = strip_tags(trim($this->request->getPost('event_color')));
				$event_note = strip_tags(trim($this->request->getPost('event_note')));
