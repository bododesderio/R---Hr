	...
	public function add_meeting() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$conference_title = strip_tags(trim($this->request->getPost('conference_title')));
				$conference_date = strip_tags(trim($this->request->getPost('conference_date')));
				$conference_time = strip_tags(trim($this->request->getPost('conference_time')));
				$conference_room = strip_tags(trim($this->request->getPost('conference_room')));
				$conference_color = strip_tags(trim($this->request->getPost('conference_color')));
				$conference_note = strip_tags(trim($this->request->getPost('conference_note')));
