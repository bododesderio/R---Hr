	...
	public function add_resignation() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$notice_date = strip_tags(trim($this->request->getPost('notice_date')));
				$resignation_date = strip_tags(trim($this->request->getPost('resignation_date')));
	...
	public function update_resignation() {
		...
		if (strip_tags(trim($this->request->getPost('type'))) === 'edit_record') {
			...
			if(!$this->validate($rules)){
				...
				$notice_date = strip_tags(trim($this->request->getPost('notice_date')));
				$resignation_date = strip_tags(trim($this->request->getPost('resignation_date')));
				$reason = strip_tags(trim($request->getPost('reason')));		
