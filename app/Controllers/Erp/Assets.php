	...
	public function add_asset() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$asset_name = strip_tags(trim($this->request->getPost('asset_name')));
				$category_id = strip_tags(trim($this->request->getPost('category_id')));
				$brand_id = strip_tags(trim($this->request->getPost('brand_id')));
				$company_asset_code = strip_tags(trim($this->request->getPost('company_asset_code')));
				$is_working = strip_tags(trim($this->request->getPost('is_working')));
				$purchase_date = strip_tags(trim($this->request->getPost('purchase_date')));
				$invoice_number = strip_tags(trim($this->request->getPost('invoice_number')));
				$manufacturer = strip_tags(trim($this->request->getPost('manufacturer')));
				$serial_number = strip_tags(trim($this->request->getPost('serial_number')));
				$warranty_end_date = strip_tags(trim($this->request->getPost('warranty_end_date')));
				$asset_note = strip_tags(trim($this->request->getPost('asset_note')));
