	...
	public function add_customfield() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$module = strip_tags(trim($this->request->getPost('module')));
				$name = strip_tags(trim($this->request->getPost('name')));
				$field_label = strip_tags(trim($this->request->getPost('field_label')));
				$priority = strip_tags(trim($this->request->getPost('priority')));
				$validation = strip_tags(trim($this->request->getPost('validation')));
				$field_type = strip_tags(trim($this->request->getPost('field_type')));
				$column = strip_tags(trim($this->request->getPost('column')));
