...
<div class="mb-3 sw-container tab-content">
  <div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
    <ul class="nav nav-tabs step-anchor">
      ...
      <?php //} ?>
      <li class="nav-item active"> <a href="<?= site_url('erp/employee-leave/').$segment_id;?>" class="mb-3 nav-link"> <span class="sw-done-icon lnr lnr-calendar-full"></span> <span class="sw-icon lnr lnr-calendar-full"></span>
        <?= lang('left_leaves');?>
        <div class="text-muted small">
                ...
                <div class="box-datatable table-responsive">
                  <table class="datatables-demo table table-striped table-bordered xin_ci_table" id="xin_hr_table">
                    <thead>
                      <tr>
                        <th><?= lang('xin_view');?></th>
                        <th width="250"><?= lang('xin_leave_type');?></th>
                        <th><?= lang('left_department');?></th>
                        <th><i class="fa fa-calendar"></i>
                          <?= lang('xin_leave_duration');?></th>
                        <th><i class="fa fa-calendar"></i>
                          <?= lang('xin_applied_on');?></th>
                      </tr>
                    </thead>
                    <tbody>
