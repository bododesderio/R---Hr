            ...
            <div class="tab-pane show active" id="payment-information">
                <div class="card">
                    ...
                    <div class="accordion" id="accordionExample">
                       <!-- PayPal removed in Phase 3.1 -->
                        <?php if($xin_super_system['stripe_active'] == 'yes'):?>
                        <div class="card mb-0 shadow-none border-top">
                            <div class="card-header" id="headingTwo">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="BillingCard" name="billingOptions" class="custom-control-input" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo" checked>
