               ...
               <div class="row">
                  <div class="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2 col-lg-8 offset-lg-2">
                     ...
                     <div class="alert alert-success" role="alert">
                        ...
                        <div class="alert alert-info" role="alert">Set your company name, admin login username, email and password.<br />
                        ...
                        <div class="sign__form">
                           <form id="set_up" method="post" action="set_up.php" autocomplete="off">
                              ...
                              <div class="sign__input-wrapper mb-25">
                                 <h5>Passsword <span class="text-danger">*</span></h5>
                                 <div class="sign__input">
